...
{
    public const URL_MATCH = 'https://%s.api.riotgames.com/lol/match/v5/matches/%s';
    public const URL_MATCH_BY_PUUID = 'https://%s.api.riotgames.com/lol/match/v5/matches/by-puuid/%s/ids?type=%s&start=%d&count=%d';
